...
LIBERO_CONFIG_PATH=/home/irom-lab/projects/openpi-cot/third_party/openpi/third_party/libero PYTHONPATH=$PYTHONPATH:$PWD/third_party/openpi/third_party/libero python scripts/libero/main.py --args.policy-type COT_FT --args.control-mode OSC_POSE
EVAL_STATUS=$?
