...
PACO_PROMPT_PARTS = [
    ...
    ("If any ", " are present, show their bounding boxes."),
    ("Show all ", " in the image by drawing bounding boxes."),
    ("Please locate the ", " using a bounding box."),
    ("Detect the ", " and provide its bounding box."),
    ("Find any ", " in the picture and draw bounding boxes around them."),
    ...
    ("Show me all visible ", " using bounding boxes."),
    ...
    ("Locate every ", " and provide bounding boxes."),
    ("Draw bounding boxes around all occurrences of ", "."),
    ("Find and outline the ", " with a bounding box."),
    ("Mark every instance of ", " using bounding boxes."),
]


class Paco(_BaseVQADataset):
