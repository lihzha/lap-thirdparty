...
PIXMO_POINT_PROMPT_PARTS = [
    ...
    ("Point out every ", " in the image."),
    ("Point to the ", " in the image."),
    ("Locate each ", " in the image."),
    ("Can you point out all ", " in this image?"),
    ("Please find ", " and show me where they are."),
    ("If there are any ", " present, indicate their positions."),
    ("If there is a ", " present, indicate its position."),
    ("Show me all visible ", "."),
]
