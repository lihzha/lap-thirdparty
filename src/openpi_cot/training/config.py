...
_CONFIGS = [
    ...
    *create_multi_device_configs(
        base_name="gemma3_combined_fast_cot",
        devices=["v6", "v6europe", "v4", "local", "v5", "v5europe"],
        model=pi_cot_config.PiCoTConfig(
            action_dim=7,
            action_horizon=16,
    ...
    *create_multi_device_configs(
        base_name="gemma3_27b_combined_cot",
        devices=["v6", "v6europe", "v4", "local", "v5", "v5europe"],
        model=pi_cot_config.PiCoTConfig(
            action_dim=7,
            action_horizon=16,
        ...
        weight_loader=weight_loaders.WeightLoaderChoice(kind="gemma3", params_path="gs://pi0-cot/cache/gemma3-27b-it"),  # params_path auto-set from variant
        ema_schedule_choice=EmaScheduleChoice(kind="cosine_delayed", start_step=5000),
        optimizer=_optimizer.AdamW(weight_decay=0.0001),
        save_interval=1000,
        keep_period=5000,
